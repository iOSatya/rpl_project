...
?>
  ...
  <img id="background" src="./../images/Level 7/Background.png">
  ...
  <div id="story" style="opacity: 0;">
    <div class="d-flex flex-column p-4" style="height: 100vh;">
      ...
      <div id="conversationSkip" class="d-flex flex-column mt-auto">
        <img id="character" src="./../images/Level 7/Boss.png" class="align-self-end" style="height: 300px; width: 500px; object-position: 0px 0px; object-fit: cover; display: none;">
  ...
  <div id="gameplay">
    ...
    <div class="d-flex flex-column justify-content-center align-items-center" style="height: 100vh;">
      ...
      <div>
        ...
        <span class="text-white"><?= $_SESSION["bossHp"]; ?></span>
      </div>
      ...
      <div class="d-flex">
        <form action="./../../controller/MapController.php" method="post">
          ...
          <input type="hidden" name="mapRegion" value="Level7Map">
  ...
  <script>
    ...
    const conversationList = [
      'Step... Step...',
      '"Intruder detected. Threat to city stasis identified."',
      '"Wait! I\'m not here to cause harm. What happened to this place?"',
      '"This city is under my protection. It must remain preserved, untouched by the ravages of time and warmth."',
      '"But everything\'s frozen. The people, the life, it\'s all gone!"',
      '"Gone? No. Preserved. Safe. Eternal."',
      '"This isn\'t preservation, it\'s destruction! Can\'t you see that?"',
      '"Illogical. Warmth brings decay. Change brings ruin. My purpose is to protect."',
      '"Who gave you that purpose? What were you before... this?"',
      '"Before? I... error. Data corrupted. Irrelevant. You bring warmth. Warmth is danger."',
      '"I can help you remember, help this city live again!"',
      '"Negative. Stasis must be maintained. All threats will be neutralized."',
      '"Then I\'ll have to show you the truth through action!"',
      '"Commencing purge protocol. Prepare for neutralization, intruder."'
    ];
