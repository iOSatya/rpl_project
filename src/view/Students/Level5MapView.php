...
?>
  ...
  <img id="background" src="./../images/Level 5/Background.png">
    ...
    <div class="d-flex flex-column justify-content-center align-items-center" style="height: 100vh;">
      ...
      <div class="d-flex">
        <form action="./../../controller/MapController.php" method="post">
          ...
          <input type="hidden" name="mapRegion" value="Level5Map">
  ...
  <script>
    ...
    const conversationList = [
      'Step... Step...',
      '"Tick tock, wanderer. You\'re late... or perhaps too early?"',
      '"Who\'s there? Show yourself!"',
      '"I am the Keeper of Moments, the Architect of Eternity. This village? My masterpiece, frozen in its most perfect instant."',
      '"What...?"',
      '"An illusion, dear one. Time loops here, ever-repeating. The same blooms, the same breeze, for all eternity."',
      '"I can\'t let you keep them trapped like this."',
      '"Oh, a hero, are we? Very well. Let\'s see how you fare when yesterday becomes tomorrow, and tomorrow slips into yesterday!"',
    ];
